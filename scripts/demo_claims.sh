...
C1=$(post /claims provider-1 '{"provider_id":"PRV-2201","beneficiary_id":"BEN-7731","procedure_code":"99214","amount":1250}' | id)
...
echo "2. denial"
C2=$(post /claims provider-1 '{"provider_id":"PRV-2201","beneficiary_id":"BEN-8102","procedure_code":"27447","amount":18400}' | id)
